...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <main className="inner-page about-page">
    <section className="page-hero about-hero"><p className="eyebrow">{t.aboutPageEyebrow}</p><h1>{t.aboutPageTitle}</h1><div className="about-hero-image"><Image src="/media/quiet-character.png" alt={locale === "en" ? "Portrait in a Paris atelier" : "Portrait dans un atelier parisien"} fill priority sizes="100vw" /></div></section>
    ...
    <section className="pricing-note"><p>{t.pricing}</p><a className="text-link" href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">{t.contactWhatsApp} ↗</a></section>
